/*  TODO: 
    research pagination to see if response time can be cut, example in courses.js and index.js
    research using the headers to set the timer, examples in courses.js and index.js
*/
